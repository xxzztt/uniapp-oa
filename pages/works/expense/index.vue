<template>
	<view class="get">
		<view class="get-list">
			<view v-for="(item, index) in getList" :key="index" class="row" @tap="navTo(`/pages/works/expense/detail?id=${item.id}`)">
				<view class="carrier">
		...
		<view class="add-round bg-deepBlue" :class="'bg-' + themeColor.name" @click="navTo(`/pages/works/expense/add`)">
